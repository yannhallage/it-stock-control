...
import { getAssetByIdService } from '../services/assets.service'
import {
  formatBrandModel,
  formatEmployeeName,
  getBrandName,
...
import { assetStatusLabel, formatDate } from '@shared/utils/format'
import type { Assignment, AssetStatus, HistoryEvent } from '@core/models'
import type { AssetDetailsApi, RepairFromApi } from '@core/models'
