...
import { assetStatusLabel } from '@shared/utils/format'
...
const statusStyles: Record<AssetStatus, string> = {
  ...
  EN_PRET: 'bg-sky-100 text-sky-800',
...
export function StatusBadge({ status }: { status: AssetStatus }) {
  const isActive = ['EN_SERVICE', 'AFFECTE', 'EN_PRET', 'EN_STOCK_NON_AFFECTE'].includes(status)
